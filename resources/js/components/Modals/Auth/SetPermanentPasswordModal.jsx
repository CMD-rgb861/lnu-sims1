...
const SetPermanentPasswordModal = ({ opened, onClose, onSubmit, isSubmitting, onLogout }) => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <Text size="sm" c="dimmed" mb="xs">
                Please set a permanent password to proceed and complete initial account setup.
            </Text>
            ...
            <Group position="apart" mt="xl" justify="right">
                <Button variant="subtle" color="gray" onClick={onLogout}>Logout</Button>
                <Button 
                    variant="light"
                    type="submit" 
                    color="teal" 
                    ...
                    fz="xs"
                    disabled={strength < 100 || newPassword !== confirmPassword}
                    >
...
export default SetPermanentPasswordModal;