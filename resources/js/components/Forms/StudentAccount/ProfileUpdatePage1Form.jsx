...
const ProfileUpdatePage1Form = ({
  ...
  // Helper to safely format dropdown data for Mantine Selects
  const formatSelectData = (data, valueKey, labelKey) => {
    if (!data || !Array.isArray(data)) return [];
    return data.map((item) => ({
      value: String(item[valueKey] || item.code || item.id || ''),
    ...
    <Paper withBorder p="lg" radius="lg">
        <Stack>
            ...
            <Grid>
                ...
                <Grid.Col span={{ base: 12, sm: 8 }}>
                    <TextInput
                        withAsterisk
                        label="Email Address"
                        placeholder="e.g. 2500000@gmail.com"
            ...
            <Grid>
                ...
                <Grid.Col span={{ base: 12, sm: 8 }} display={{ base: 'none', sm: 'block' }} />
                ...
                <Grid.Col span={{ base: 12, sm: 4 }} mb="md">
                    <TextInput
                        label="ZIP Code"
...
export default ProfileUpdatePage1Form;