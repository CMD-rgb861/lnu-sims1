...
class FamBackgroundController extends Controller
{
    ...
    private function getFamBackgroundData($id)
    {
    ...
    public function famBackgroundIndex()
    {
        $id = Auth::id();
        $data = $this->getFamBackgroundData($id);

        return view('pages.students.my_profile.fam_background_layout', $data);
    }
